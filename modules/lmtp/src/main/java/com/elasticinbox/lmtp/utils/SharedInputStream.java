 ...
 * determine the current position in the InputStream, and to create new
 ...
 * <code>close</code> method does not close any underlying stream that might be
 * shared by multiple instances of <code>SharedInputStream</code> until all
 * shared instances have been closed.
 * 
 * @author Bill Shannon
 * @since JavaMail 1.2
 */
